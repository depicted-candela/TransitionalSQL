...
--  Answer: The connection pool enables the application to be connected immediately to the database with credentials of specific users or roles stored in a tool of
-- confs
...
--  Answer: The core difference is that the DRCP has incorporated default configured resources for a small number of specific connection, enabling fast connections
...
-- manipulation?
-- Answer: XMLTYPE is insanely superior because of its structured approach storing things, CLOB is just a binary character concatenation
