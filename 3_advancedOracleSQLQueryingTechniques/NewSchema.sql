...
BEGIN
    EXECUTE IMMEDIATE 'DROP USER advanced_querying CASCADE';
EXCEPTION
    WHEN OTHERS THEN
...
GRANT CONNECT, RESOURCE TO advanced_querying;
...
GRANT CREATE VIEW TO advanced_querying;

-- If you plan to use database links (not in your script, but for completeness):
GRANT CREATE DATABASE LINK TO advanced_querying;

-- If you need to run ALTER SESSION (like for TIME_ZONE):
GRANT ALTER SESSION TO advanced_querying;
