...
BEGIN
    EXECUTE IMMEDIATE 'DROP USER conqueringcomplexities CASCADE';
EXCEPTION
    WHEN OTHERS THEN
...
CREATE USER conqueringcomplexities
...
GRANT CONNECT, RESOURCE TO conqueringcomplexities;
...
GRANT CREATE VIEW TO conqueringcomplexities;

-- If you plan to use database links (not in your script, but for completeness):
GRANT CREATE DATABASE LINK TO conqueringcomplexities;

-- If you need to run ALTER SESSION (like for TIME_ZONE):
GRANT ALTER SESSION TO conqueringcomplexities;
