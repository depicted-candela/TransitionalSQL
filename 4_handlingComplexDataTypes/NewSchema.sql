...
BEGIN
    EXECUTE IMMEDIATE 'DROP USER handling_complex_datatype CASCADE';
EXCEPTION
    WHEN OTHERS THEN
...
CREATE USER handling_complex_datatype
...
GRANT CONNECT, RESOURCE TO handling_complex_datatype;
...
GRANT CREATE VIEW TO handling_complex_datatype;

-- If you plan to use database links (not in your script, but for completeness):
GRANT CREATE DATABASE LINK TO handling_complex_datatype;

-- If you need to run ALTER SESSION (like for TIME_ZONE):
GRANT ALTER SESSION TO handling_complex_datatype;
