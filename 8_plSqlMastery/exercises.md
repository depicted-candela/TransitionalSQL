...
<ol>
    ...
    <li>Declare a <code>Varray</code> variable <code>smallStringArray</code> of size 3. Initialize it with 3 elements. Attempt to <code>EXTEND</code> it to size 4. Handle the expected exception (<code>SUBSCRIPT_OUTSIDE_LIMIT</code>).</li>
